...
namespace Alexvkokin\Patterns\Behavioral\Middleware\ChainOfResponsibility;

use Alexvkokin\Patterns\Behavioral\Middleware\ChainOfResponsibility\Middleware\Middleware;
